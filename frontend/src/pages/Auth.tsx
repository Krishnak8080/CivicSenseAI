        ...
        <Card className="bg-[var(--bg-card)] border-[var(--border-subtle)] p-8 shadow-2xl">
          {showSuccess ? (
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-white text-center">Authentication Successful</h2>
              ...
              <div className="flex mb-8 bg-[var(--bg-secondary)] rounded-lg p-1 border border-[var(--border-subtle)]">
                <button 
                  ...
                  className={`flex-1 py-2 text-sm font-semibold rounded-md transition-all duration-200 ${
                    tab === 'login' ? 'bg-[var(--bg-elevated)] text-white shadow-sm' : 'text-[var(--text-secondary)] hover:text-white'
                  }`}
                >
                  Login
                </button>
                <button 
                  ...
                  className={`flex-1 py-2 text-sm font-semibold rounded-md transition-all duration-200 ${
                    tab === 'register' ? 'bg-[var(--bg-elevated)] text-white shadow-sm' : 'text-[var(--text-secondary)] hover:text-white'
                  }`}
                >
                  Register
                </button>
