      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="#about"
                  className="text-white/60 hover:text-orange-primary transition-colors"
                >
                  About Us
                </a>
              </li>
              ...
              <li>
                <a href="#" className="text-white/60 hover:text-orange-primary transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="mailto:support@civicsenseai.in"
                  className="text-white/60 hover:text-orange-primary transition-colors"
                >
                  support@civicsenseai.in
                </a>
              </li>
              <li>
                <a href="#" className="text-white/60 hover:text-orange-primary transition-colors">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-white/40 text-sm flex items-center gap-2">
            ...
            <span className="inline-block w-4 h-4 rounded-full bg-gradient-to-br from-[#FF9933] via-white to-[#138808]" />
          </p>
        </div>
      </div>
    </footer>
