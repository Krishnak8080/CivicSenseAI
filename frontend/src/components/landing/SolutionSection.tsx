...
export function SolutionSection() {
  ...
  const solutions = [
    {
      title: "REPORT",
      icon: <Camera size={32} className="text-orange-primary group-hover:scale-110 transition-transform duration-300" />,
      items: [
    ...
    {
      title: "PRIORITIZE",
      icon: <BrainCircuit size={32} className="text-orange-primary group-hover:scale-110 transition-transform duration-300" />,
      items: [
    ...
    {
      title: "RESOLVE",
      icon: <CheckCircle2 size={32} className="text-orange-primary group-hover:scale-110 transition-transform duration-300" />,
      items: [
          ...
          {solutions.map((solution, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-6 tracking-wide">{solution.title}</h3>
