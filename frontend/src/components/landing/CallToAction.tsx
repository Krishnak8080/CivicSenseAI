      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <h2 className="text-5xl md:text-7xl lg:text-[90px] font-black text-white mb-8 tracking-tighter leading-none">
            READY TO MAKE A{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-primary to-orange-glow">
              DIFFERENCE?
            </span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            ...
            <Button
              variant="outline"
              className="w-full sm:w-auto h-16 px-10 border-white/20 text-white hover:bg-white/10 bg-transparent rounded-full text-xl font-bold transition-all hover:scale-105"
            >
