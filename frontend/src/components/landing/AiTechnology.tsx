      ...
      <div className="container mx-auto px-6 relative z-10" ref={ref}>
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            >
              Our Claude-powered AI acts as a digital city planner. It analyzes every single report
              in real-time, scanning for:
            </motion.p>
            ...
            >
              Then assigns an initial priority that the community can refine through democratic
              voting.
            </motion.p>
          </div>
        </div>
