...
const mockMarkers = [
  { id: 1, lat: 28.6149, lng: 77.209, priority: 'high', title: 'Pothole on Main Road' },
  { id: 2, lat: 28.6129, lng: 77.21, priority: 'medium', title: 'Broken Streetlight' },
  { id: 3, lat: 28.6159, lng: 77.207, priority: 'low', title: 'Garbage Pile' },
];
    ...
    <section className="relative h-[800px] md:h-[900px] overflow-hidden bg-background-dark">
      ...
      <div className="absolute inset-0 z-0 opacity-50 grayscale hover:grayscale-0 transition-all duration-1000">
        {isLoaded ? (
                      ...
                      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="' +
                        (marker.priority === 'high'
                          ...
                          : marker.priority === 'medium'
                            ? '#F59E0B'
                            : '#FBBF24') +
                        '" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/></svg>'
                    ),
          ...
          <div className="w-full h-full bg-[#111111] flex items-center justify-center text-white/50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
          ...
          >
            <h2 className="text-5xl md:text-6xl font-black text-white mb-4 uppercase tracking-tight">
              YOUR <span className="text-orange-primary">NEIGHBORHOOD</span>
              <br />
              YOUR VOICE
            </h2>
            <p className="text-xl md:text-2xl text-white/70 mb-10 font-light">
              See what's happening within 5km of you. Support issues that matter, and watch as your
          ...
          <div className="hidden lg:flex flex-col gap-6 justify-center items-end pr-8">
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-white font-bold text-lg leading-tight">
                  Massive Pothole on Sector 4 Road
                </h3>
              ...
              <p className="text-white/60 text-sm mb-4 line-clamp-2">
                This pothole has been causing massive traffic jams and damage to vehicles during
                rush hour...
              </p>
            ...
            >
              ...
              <p className="text-white/60 text-sm mb-4 line-clamp-2">
                The streetlights near the park have been out for 3 days making it unsafe to walk at
                night...
              </p>
              <div className="flex justify-between items-center text-sm">
