...
export function ProblemSection() {
  ...
  const problems = [
    ...
    { icon: <AlertTriangle className="text-red-500" size={24} />, text: "No system to track neighborhood problems" },
    { icon: <EyeOff className="text-red-500" size={24} />, text: "Government lacks real-time citizen feedback" },
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black text-white mb-6 uppercase tracking-tight">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-primary to-orange-dark">Problem</span>
            </h2>
            ...
            <p className="text-xl md:text-2xl text-white/60 font-light leading-relaxed max-w-2xl">
              Cities are growing faster than our ability to maintain them. Traditional reporting methods are slow, opaque, and discourage citizen participation.
            </p>
          </motion.div>
              ...
              <ul className="space-y-8 relative z-10">
                {problems.map((problem, idx) => (
                  ...
                  >
                    ...
                    <span className="text-lg md:text-xl text-white font-medium">{problem.text}</span>
                  </motion.li>
                ))}
              </ul>
            </div>
