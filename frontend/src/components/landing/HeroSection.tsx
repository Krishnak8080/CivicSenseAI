    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 z-10 relative">
        <div className="max-w-4xl">
          ...
          >
            Report civic issues with a tap. Let AI prioritize what matters. 
            Watch your community vote for change. See real impact.
          </motion.p>
          ...
          >
            ...
            <a href="#how-it-works">
              <Button variant="outline" className="w-full sm:w-auto h-14 px-8 border-white/20 text-white hover:bg-white/10 bg-transparent rounded-full text-lg">
                Learn More ↓
              </Button>
            </a>
          </motion.div>
