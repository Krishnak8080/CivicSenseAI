...
export function ImpactStats() {
  ...
  const stats = [
    { number: 1000, label: "Active Citizens", color: "bg-orange-primary text-white", dot: "bg-white" },
    { number: 450, label: "Issues Reported", color: "bg-[#222222] text-white", dot: "bg-orange-primary" },
    { number: 280, label: "Problems Resolved", color: "bg-[#111111] text-white", dot: "bg-green-500" },
