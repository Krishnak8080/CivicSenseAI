...
const mockMarkers = [
  { id: 1, lat: 28.6149, lng: 77.2090 },
  { id: 2, lat: 28.6129, lng: 77.2100 },
  { id: 3, lat: 28.6159, lng: 77.2070 },
  { id: 4, lat: 28.6180, lng: 77.2000 },
  { id: 5, lat: 28.6090, lng: 77.2150 },
];
    ...
    >
      <div className="relative w-full h-full">
        ...
        {isLoaded ? (
          ...
          >
            {showPins && mockMarkers.map((marker) => (
